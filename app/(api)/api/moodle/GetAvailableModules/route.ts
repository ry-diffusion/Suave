import { badAuthorizationError } from "@/lib/api/api-errors";
import AuthenticatedMobileApi, { Assignment, ContentData, ModuleData, Quiz } from "@/lib/moodle/AuthenticatedMobileApi";
