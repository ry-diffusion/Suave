...
function Acessar({url}: { url: string }) {
    return <Link href={url}
                 className="rounded-3xl bg-blue-500 text-black p-4 max-w-24 hover:scale-110 transition-all shadow-sm shadow-blue-800 hover:bg-green-200 mt-auto self-start"
                 target="_blank">
        Acessar
    </Link>
}
...
function TimeCategory({name, modules, showOpenDate}: {
    ...
    return <div className={`flex flex-col gap-4 items-center min-w-full`}>
        <div className="flex gap-2 justify-items-center items-center">
            <button className="bg-green-200 rounded-full p-2 hover:scale-110 transition-all text-black"
