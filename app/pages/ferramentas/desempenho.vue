      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <div class="flex items-center">
            <UIcon name="i-lucide-calendar-days" class="mr-2 text-gray-500 flex-shrink-0" />
            <span class="font-medium break-words">42 dias</span>
          </div>
        </div>
        <div>
          <h3 class="text-sm font-medium mb-2">Próxima avaliação</h3>
          <div class="flex items-center">
            <UIcon name="i-lucide-file-text" class="mr-2 text-gray-500 flex-shrink-0" />
            <span class="font-medium break-words">15/06 - Cálculo III</span>
          </div>
        </div>
      </div>
    </UCard>
    ...
    <UCard>
      <template #header>
        <div class="flex items-center justify-between">
          ...
          <USelect v-model="selectedSemester" :options="semesters" placeholder="Selecionar semestre" class="w-40" />
        </div>
      </template>
