...
export default function Inicio() {
    return <Content>
        ...
        <div className="grid gap-8">
            <UrlLink url="/ead/available" className="bg-yellow-200">
                <Image src="/moodle.svg" alt="Logo do Moodle" width={20} height={20}/>
                Ver os moodles disponíveis
            </UrlLink>

            <UrlLink url="/academic/performance" className="bg-blue-200">
                <Image src="/grade-a.svg" alt="Logo do Moodle" width={20} height={20}/>
                Analisar o desempenho acadêmico
            </UrlLink>


            <UrlLink url="https://nubank.com.br/cobrar/jk28o/67331f9e-cafa-416c-b3ef-bb0ca933c88e"
